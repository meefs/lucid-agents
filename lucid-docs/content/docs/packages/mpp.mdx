...
The MPP extension protects invoke, stream, and A2A task execution with standard Payment-Auth `402 Payment Required` challenges. Every adapter delegates to the same authorization gate.
