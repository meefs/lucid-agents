...
The client-side `wrapFetchWithSIWx` helper handles both cases automatically. See the [payments package README](/docs/packages/payments) for full configuration and client-side setup.
