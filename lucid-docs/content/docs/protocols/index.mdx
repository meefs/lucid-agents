...
| [MPP](/docs/protocols/mpp)           | Active individual Internet-Draft `draft-ryan-httpauth-payment-01` | Next-only Payment-Auth integration through `mppx` 0.4.11                     | Native charge or application verifier; not the full MPP surface  |
