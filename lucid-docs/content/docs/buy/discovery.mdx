...
| Lucid storefront           | Service UI derived from card/entrypoints     | Human-readable capabilities; forms/wallet flow in React        | Same authority as deployed service; UI can become stale/misconfigured    | Static server or generated React UI |
