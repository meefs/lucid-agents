...
The CLI validates a template and framework adapter, builds the project in a
staging directory, writes wizard answers to the generated environment, and
optionally installs dependencies. It commits the target only after those steps
succeed. It is a project generator, not a runtime dependency.
